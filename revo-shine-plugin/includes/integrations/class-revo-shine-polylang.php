...
if (!class_exists('Revo_Shine_Polylang')) {
	class Revo_Shine_Polylang extends Revo_Shine_Integration
	{
		...
		{
			if (!$this->collect_plugin('polylang/polylang.php')) {
				return;
			}
		...
		{
			register_rest_route($this->namespace, $this->sub . '/get-languages', array(
				'methods'             => 'POST',
				'callback'            => array($this, 'rest_polylang_get_languages'),
				'permission_callback' => '__return_true'
			));

			register_rest_route($this->namespace, $this->sub . '/get-products', array(
				'methods'             => 'POST',
				'callback'            => array($this, 'rest_polylang_get_products'),
				'permission_callback' => '__return_true'
			));

			register_rest_route($this->namespace, $this->sub . '/get-post', array(
				'methods'             => 'POST',
