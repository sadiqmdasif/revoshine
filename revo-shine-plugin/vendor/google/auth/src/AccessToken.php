 ...
 */
namespace _PhpScoper01187d35592a\Google\Auth;

use DateTime;
use _PhpScoper01187d35592a\Firebase\JWT\ExpiredException;
...
use _PhpScoper01187d35592a\Google\Auth\HttpHandler\HttpClientCache;
use _PhpScoper01187d35592a\Google\Auth\HttpHandler\HttpHandlerFactory;
use _PhpScoper01187d35592a\GuzzleHttp\Psr7\Request;
use _PhpScoper01187d35592a\GuzzleHttp\Psr7\Utils;
use InvalidArgumentException;
use _PhpScoper01187d35592a\phpseclib\Crypt\RSA;
use _PhpScoper01187d35592a\phpseclib\Math\BigInteger as BigInteger2;
use _PhpScoper01187d35592a\phpseclib3\Crypt\PublicKeyLoader;
use _PhpScoper01187d35592a\phpseclib3\Math\BigInteger as BigInteger3;
use _PhpScoper01187d35592a\Psr\Cache\CacheItemPoolInterface;
use RuntimeException;
use _PhpScoper01187d35592a\SimpleJWT\InvalidTokenException;
use _PhpScoper01187d35592a\SimpleJWT\JWT as SimpleJWT;
use _PhpScoper01187d35592a\SimpleJWT\Keys\KeyFactory;
use _PhpScoper01187d35592a\SimpleJWT\Keys\KeySet;
...
class AccessToken
{
    ...
    {
        if (!\class_exists('_PhpScoper01187d35592a\\phpseclib\\Crypt\\RSA')) {
            return \false;
        }
        /**
        ...
        if (\filter_var(\getenv('GAE_VM'), \FILTER_VALIDATE_BOOLEAN)) {
            ...
            if (!\defined('_PhpScoper01187d35592a\\CRYPT_RSA_MODE')) {
                \define('_PhpScoper01187d35592a\\CRYPT_RSA_MODE', RSA::MODE_OPENSSL);
            }
        }
        return \true;
    }
    ...
    {
        return \class_exists('_PhpScoper01187d35592a\\phpseclib3\\Crypt\\RSA');
    }
    /**
     * @return void
     */
