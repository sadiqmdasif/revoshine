 ...
 */
namespace _PhpScoper01187d35592a\Google;

use BadMethodCallException;
use DomainException;
use _PhpScoper01187d35592a\Google\AccessToken\Revoke;
use _PhpScoper01187d35592a\Google\AccessToken\Verify;
use _PhpScoper01187d35592a\Google\Auth\ApplicationDefaultCredentials;
use _PhpScoper01187d35592a\Google\Auth\Cache\MemoryCacheItemPool;
use _PhpScoper01187d35592a\Google\Auth\Credentials\ServiceAccountCredentials;
use _PhpScoper01187d35592a\Google\Auth\Credentials\UserRefreshCredentials;
...
use _PhpScoper01187d35592a\Google\Auth\OAuth2;
use _PhpScoper01187d35592a\Google\AuthHandler\AuthHandlerFactory;
use _PhpScoper01187d35592a\Google\Http\REST;
use _PhpScoper01187d35592a\GuzzleHttp\Client as GuzzleClient;
use _PhpScoper01187d35592a\GuzzleHttp\ClientInterface;
use _PhpScoper01187d35592a\GuzzleHttp\Ring\Client\StreamHandler;
use InvalidArgumentException;
use LogicException;
use _PhpScoper01187d35592a\Monolog\Handler\StreamHandler as MonologStreamHandler;
use _PhpScoper01187d35592a\Monolog\Handler\SyslogHandler as MonologSyslogHandler;
