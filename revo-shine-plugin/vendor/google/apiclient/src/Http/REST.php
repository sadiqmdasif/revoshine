 ...
 */
namespace _PhpScoper01187d35592a\Google\Http;

use _PhpScoper01187d35592a\Google\Auth\HttpHandler\HttpHandlerFactory;
use _PhpScoper01187d35592a\Google\Service\Exception as GoogleServiceException;
use _PhpScoper01187d35592a\Google\Task\Runner;
use _PhpScoper01187d35592a\GuzzleHttp\ClientInterface;
use _PhpScoper01187d35592a\GuzzleHttp\Exception\RequestException;
use _PhpScoper01187d35592a\GuzzleHttp\Psr7\Response;
...
class REST
{
    ...
    public static function doExecute(ClientInterface $client, RequestInterface $request, $expectedClass = null)
    {
        try {
            ...
            if (\interface_exists('_PhpScoper01187d35592a\\GuzzleHttp\\Message\\ResponseInterface') && $response instanceof \_PhpScoper01187d35592a\GuzzleHttp\Message\ResponseInterface) {
