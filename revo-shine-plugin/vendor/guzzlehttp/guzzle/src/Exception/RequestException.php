...
namespace _PhpScoper01187d35592a\GuzzleHttp\Exception;

use _PhpScoper01187d35592a\GuzzleHttp\BodySummarizer;
use _PhpScoper01187d35592a\GuzzleHttp\BodySummarizerInterface;
use _PhpScoper01187d35592a\Psr\Http\Client\RequestExceptionInterface;
