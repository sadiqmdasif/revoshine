...
use _PhpScoper01187d35592a\GuzzleHttp\Promise as P;
use _PhpScoper01187d35592a\GuzzleHttp\Promise\FulfilledPromise;
use _PhpScoper01187d35592a\GuzzleHttp\Promise\PromiseInterface;
use _PhpScoper01187d35592a\GuzzleHttp\Psr7\LazyOpenStream;
use _PhpScoper01187d35592a\GuzzleHttp\TransferStats;
use _PhpScoper01187d35592a\GuzzleHttp\Utils;
...
class CurlFactory implements CurlFactoryInterface
{
    ...
    private function applyHandlerOptions(EasyHandle $easy, array &$conf) : void
    {
        ...
        if (!isset($options['sink'])) {
            ...
            $options['sink'] = \_PhpScoper01187d35592a\GuzzleHttp\Psr7\Utils::tryFopen('php://temp', 'w+');
        }
        $sink = $options['sink'];
        if (!\is_string($sink)) {
            $sink = \_PhpScoper01187d35592a\GuzzleHttp\Psr7\Utils::streamFor($sink);
