 ...
 */
namespace _PhpScoper01187d35592a\phpseclib3\Math\BigInteger\Engines;
...
abstract class PHP extends Engine
{
    ...
    {
        if (\strtoupper(\substr(\PHP_OS, 0, 3)) === 'WIN' && \function_exists('opcache_get_status') && !\defined('_PhpScoper01187d35592a\\PHPSECLIB_ALLOW_JIT')) {
