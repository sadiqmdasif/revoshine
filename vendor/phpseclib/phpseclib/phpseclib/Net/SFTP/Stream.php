 ...
 */
namespace _PhpScoper01187d35592a\phpseclib3\Net\SFTP;

use _PhpScoper01187d35592a\phpseclib3\Crypt\Common\PrivateKey;
use _PhpScoper01187d35592a\phpseclib3\Net\SFTP;
...
class Stream
{
    ...
    {
        if (\defined('_PhpScoper01187d35592a\\NET_SFTP_STREAM_LOGGING')) {
            echo "__construct()\r\n";
        }
    }
    /**
