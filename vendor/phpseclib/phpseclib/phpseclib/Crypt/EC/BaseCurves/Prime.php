 ...
 */
namespace _PhpScoper01187d35592a\phpseclib3\Crypt\EC\BaseCurves;

use _PhpScoper01187d35592a\phpseclib3\Common\Functions\Strings;
use _PhpScoper01187d35592a\phpseclib3\Math\BigInteger;
use _PhpScoper01187d35592a\phpseclib3\Math\Common\FiniteField\Integer;
use _PhpScoper01187d35592a\phpseclib3\Math\PrimeField;
use _PhpScoper01187d35592a\phpseclib3\Math\PrimeField\Integer as PrimeInteger;
/**
 * Curves over y^2 = x^3 + a*x + b
 *
 * @author  Jim Wigginton <terrafrost@php.net>
    ...
    public function setBasePoint($x, $y)
    {
        switch (\true) {
            case !$x instanceof BigInteger && !$x instanceof PrimeInteger:
                throw new \UnexpectedValueException('_PhpScoper01187d35592a\\Argument 1 passed to Prime::setBasePoint() must be an instance of either BigInteger or PrimeField\\Integer');
            case !$y instanceof BigInteger && !$y instanceof PrimeInteger:
                throw new \UnexpectedValueException('_PhpScoper01187d35592a\\Argument 2 passed to Prime::setBasePoint() must be an instance of either BigInteger or PrimeField\\Integer');
        }
        if (!isset($this->factory)) {
            throw new \RuntimeException('setModulo needs to be called before this method');
        }
