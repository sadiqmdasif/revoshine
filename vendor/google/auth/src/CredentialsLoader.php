...
use _PhpScoper01187d35592a\Google\Auth\Credentials\ExternalAccountCredentials;
use _PhpScoper01187d35592a\Google\Auth\Credentials\ImpersonatedServiceAccountCredentials;
use _PhpScoper01187d35592a\Google\Auth\Credentials\InsecureCredentials;
...
abstract class CredentialsLoader implements FetchAuthTokenInterface, UpdateMetadataInterface
{
    ...
    public static function makeHttpClient(FetchAuthTokenInterface $fetcher, array $httpClientOptions = [], callable $httpHandler = null, callable $tokenCallback = null)
    {
        ...
        $stack = \_PhpScoper01187d35592a\GuzzleHttp\HandlerStack::create();
        $stack->push($middleware);
        return new \_PhpScoper01187d35592a\GuzzleHttp\Client(['handler' => $stack, 'auth' => 'google_auth'] + $httpClientOptions);
    }
    /**
