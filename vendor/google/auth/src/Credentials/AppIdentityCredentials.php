 ...
 */
use _PhpScoper01187d35592a\google\appengine\api\app_identity\AppIdentityService;
...
class AppIdentityCredentials extends CredentialsLoader implements SignBlobInterface, ProjectIdProviderInterface
{
    ...
    {
        if (!self::onAppEngine() || !\class_exists('_PhpScoper01187d35592a\\google\\appengine\\api\\app_identity\\AppIdentityService')) {
