...
namespace _PhpScoper01187d35592a\Psr\Log\Test;

use _PhpScoper01187d35592a\Psr\Log\LoggerInterface;
use _PhpScoper01187d35592a\Psr\Log\LogLevel;
use _PhpScoper01187d35592a\PHPUnit\Framework\TestCase;
/**
...
abstract class LoggerInterfaceTest extends TestCase
{
    ...
    {
        $this->assertInstanceOf('_PhpScoper01187d35592a\\Psr\\Log\\LoggerInterface', $this->getLogger());
    }
    /**
    ...
    public function testObjectCastToString()
    {
        if (\method_exists($this, 'createPartialMock')) {
            $dummy = $this->createPartialMock('_PhpScoper01187d35592a\\Psr\\Log\\Test\\DummyTest', array('__toString'));
        } else {
            $dummy = $this->getMock('_PhpScoper01187d35592a\\Psr\\Log\\Test\\DummyTest', array('__toString'));
        }
