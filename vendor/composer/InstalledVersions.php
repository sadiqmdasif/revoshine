 ...
 */
namespace _PhpScoper01187d35592a\Composer;

use _PhpScoper01187d35592a\Composer\Autoload\ClassLoader;
use _PhpScoper01187d35592a\Composer\Semver\VersionParser;
/**
...
class InstalledVersions
{
    ...
    private static function getInstalled()
    {
        if (null === self::$canGetVendors) {
            self::$canGetVendors = \method_exists('_PhpScoper01187d35592a\\Composer\\Autoload\\ClassLoader', 'getRegisteredLoaders');
        }
        $installed = array();
